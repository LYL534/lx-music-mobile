...
class Track: NSObject, AudioItem, TimePitching, AssetOptionsProviding {
    ...
    // [BILI-PATCH] B站 CDN 按 User-Agent 防盗链: 移动 UA(含 AVPlayer 默认的 AppleCoreMedia UA)一律 403,
    // 必须支持 track.userAgent 显式指定 PC UA(对应 Android 端 LocalPlayback 的 UA 修改)
    ...
    func getAssetOptions() -> [String: Any] {
        ...
        // [BILI-PATCH] 覆盖 AVPlayer 默认的移动端 UA(否则 B站 CDN 403)
